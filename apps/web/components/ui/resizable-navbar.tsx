  ...
  return (
    <div className="lg:hidden w-full">
      <motion.div
        ...
        transition={{ type: "spring", stiffness: 200, damping: 50 }}
        className={cn(
          "relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between bg-transparent px-4 py-4",
          visible && "bg-white/80 dark:bg-neutral-950/80 shadow-lg",
          className
        )}
      >
  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">ImDoc</span>
    </a>
  );
};
